// AI Article Hub v4
// Long-form articles + local SVG images (no external image hosts).
...
function generateArticle(topic) {
  ...
  const titleTemplate = randomFrom([
